                    ...
                    <div class="modal-body">
                        ...
                        <form class="m-2" action="create-appointment.php" enctype="multipart/form-data" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="DurationMinutes" name="DurationMinutes" placeholder="e.g. 30"
                                    required>
                            </div>
                            <div class="form-group">
                                <label for="ReasonForAppointment">Reason for Appointment</label>
                                <textarea class="form-control" id="ReasonForAppointment" name="ReasonForAppointment" rows="3" required></textarea>
                            </div>
                            <div class="form-group">
                                <label for="BookedByReceptionistID">Receptionist</label>
                                <input type="hidden" class="form-control" id="BookedByReceptionistID" name="BookedByReceptionistID" value="1"></textarea>
                            </div>
