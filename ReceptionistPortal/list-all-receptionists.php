...
while ($row = $result->fetch_assoc()) {
    ...
    if ($row['Receptionists_ID'] == $_GET['Receptionists_ID']) {
        ...
        echo '<label for="Password">Banned:</label>';
        echo '<p class="card-text"><input type="number" class="form-control" name="Banned" value="' . $row['Banned'] . '" required autocomplete="off"></p>';
