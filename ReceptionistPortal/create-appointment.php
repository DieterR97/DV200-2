...
// sql query:
$sql = "INSERT INTO appointments (PatientsID, DoctorsID, AppointmentDate, AppointmentTime, DurationMinutes, ReasonForAppointment, BookedByReceptionistID) VALUES ('$PatientsID', '$DoctorsID', '$AppointmentDate', '$AppointmentTime', '$DurationMinutes', '$ReasonForAppointment', '$BookedByReceptionistID')";
