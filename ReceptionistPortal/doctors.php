...
if (isset($_SESSION['Receptionists_ID']) && isset($_SESSION['Username'])) {
    ...
    <head>
        ...
        <script language="JavaScript" type="text/javascript">
            function confirmation(Name, Surname, Doctors_ID) {
                if (!confirm("Delete Doctor Record for " + Name + " " + Surname + " ?")) {
                    return false;
                }
                window.location.href = "delete-doctor.php?Doctors_ID=" + Doctors_ID;
            }
        </script>
    ...
    <body>
        ...
        <div class="c-navbar">
            ...
            <a class="nav-item active-nav" href="doctors.php">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-active icon-tabler-stethoscope"
            ...
            <div class="row">
                <div class="col-md-10">
                    <div class="form-inline d-flex">
                        ...
                        <form class="m-2 d-flex width-full" action="doctors.php" enctype="multipart/form-data"
                            method="POST">
                            <input type="text" class="form-control mr-sm-2" placeholder="Search for Doctors" id="search"
                                name="search">
                        ...
                        <!-- <form class="m-2 d-flex width-full" action="doctors.php" enctype="multipart/form-data" method="POST">
                    </form> -->
            ...
            <div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <div class="ribbon">
                                            ...
                                            <span class="rating" id="rating-text"></span>
                                        </div>
                                    ...
                                    <div class="col-md-7">
                                        ...
                                        <p><strong>Room </strong><span id="Room-ID-text"></span>: <span
                                                id="Room-type-text"></span></p>
                ...
                if (isset($_POST["search"])) {
                    ...
                    if (count($results) > 0) {
                        ...
                        echo '<p>All Doctors (' . $length . ')</p>';

                    } else {
                        echo '<p>All Doctors (0)</p>';
                    }
                } else {
                    include 'db.php';

                    // Query to get the count of records in the table
                    $query = "SELECT COUNT(*) as total_records FROM doctors";
                    ...
                    // Display the count
                    echo '<p>All Doctors (' . $totalRecords . ')</p>';
                }
                ?>
                ...
                <div id="popup" class="hide-scroll">
                    <div class="relative-pop">
                        <h2 class="add-title">Add New Doctor.</h2>
                        <hr>
                        <button id="closeButton">&times;</button>

                        <form class="m-2" action="create-doctor.php" enctype="multipart/form-data" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="Specialisation" name="Specialisation"
                                    placeholder="Enter Specialisation" required>
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control" id="Room" name="Room" required>
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        echo '<option value="' . $row["Rooms_ID"] . '">Room ' . $row["RoomNumber"] . ': ' . $row["Type"] . '</option>';
                                    }
                                    ?>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" step="0.1" min="0" max="5" class="form-control" id="Rating"
                                    name="Rating" placeholder="Enter Rating out of 5" required>
                            </div>
                            <div class="form-group">
                            ...
                            <button type="submit" class="btn btn-primary btn-grad btn-add m-4">Add Doctor Profile</button>
                        </form>
        ...
        if (isset($_FILES["image"]["name"])) {
            ...
            ";
                ...
                $query = "UPDATE doctors SET ProfileImage = '$newImageName' WHERE Doctors_ID = $id";
