...
<body>
    ...
    <div class="c-navbar">
        ...
        <a class="nav-item active-nav" href="appointments.php">
            <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-active icon-tabler-bookmark"
    ...
    <div class="container content-div">
                ...
                <nav class="navbar navbar-dark bg-dark card">
                    <div class="container-fluid">
                        <a class="navbar-brand" href="#">
                            ...
                            <img src="assets/logo/Mecial Docker White.svg" alt="Logo">
                    ...
                    <div class="modal-body modal-border-b">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <p><strong>ReasonForAppointment: </strong><span id="ReasonForAppointment-text"></span></p>

                                <p><strong>BookedByReceptionistID </strong><span id="BookedByReceptionistID-text"></span>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form class="m-2" action="create-appointment.php" enctype="multipart/form-data" method="POST">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                include 'list-all-appointments.php';
